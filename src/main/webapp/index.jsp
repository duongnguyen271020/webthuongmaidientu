...
<div class="">
    ...
    <!-- Phần header -->
    <div class="header"><a href="index.html"><img src="image/logo-web1.png" alt="" width="120" height="90"
                                                  class="logo"/></a>
    ...
    <div class="container">
        ...
        <div class="menu-ben-trai">
            <ul>
                ...
                <li><a href="#"><img id="icon-mobile" src="image/fridge-icon.jpg">Tủ lạnh</a></li>
                <li><a href="#"><img id="icon-mobile" src="image/tivi-icon.jpg">Ti vi</a></li>
                <li><a href="#"><img id="icon-mobile" src="image/washing-machines-icon.png">Máy giặt</a></li>
                <li><a href="#"><img id="icon-mobile" src="image/refrigerator-icons.jpg">Máy lạnh</a></li>
            </ul>
        </div>
...
<%--                <!--End Thanh tiêu đề-->--%>
<%--                <!--Form-->--%>
<%--                <form action="/webthuongmaidientu-0/hello-servlet" method="post">--%>
<%--                    <p class="title">Vui lòng nhập thông tin</p>--%>
<%--                    <input type="text" name ="Tên đăng nhập" placeholder="Tên đăng nhập"/>--%>
<%--                    <input type="password" name="" placeholder="Mật khẩu"/>--%>
<%--                    <button type="submit">Đăng nhập</button>--%>
<%--                    <p>Hoặc</p>--%>
<%--                    <a href="dang-ky.html" style="width:120px;">Tôi chưa có tài khoản</a>--%>
